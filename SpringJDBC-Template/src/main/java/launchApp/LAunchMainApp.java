...
public class LAunchMainApp {
	...
	public static void main(String[] args) {
		...
		/*
		 * Employee emp = new Employee(); emp.setEid(112); emp.setEname("Gulam");
		 * emp.setEcity("HYD"); emp.setEsallary(50000); String status =
		 * employeeDao.add(emp); System.out.println(status);
		 */

		/*
		 * Employee emp = employeeDao.search(114); if(emp == null) {
		...
		/*
		 * Employee emp = new Employee(); emp.setEid(112); emp.setEname("Gustavo");
		 * emp.setEcity("ENG"); emp.setEsallary(12000); String status =
		 * employeeDao.update(emp); System.out.println(status);
		 */
